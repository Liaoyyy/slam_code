...
int main(int argc, char **argv) {
  ...
  // 建立3D点
  Mat depth1 = imread(first_file_depth, CV_LOAD_IMAGE_UNCHANGED);       // 深度图为16位无符号数，单通道图像
  Mat depth2 = imread(second_file_depth, CV_LOAD_IMAGE_UNCHANGED);       // 深度图为16位无符号数，单通道图像
